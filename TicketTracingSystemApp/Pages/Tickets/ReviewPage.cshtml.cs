...
namespace TicketTracingSystemApp.Pages.Tickets
{
    public class ReviewPageModel : PageModel
    {
        ...
        public ReviewPageModel(TicketRepository ticketRepository, EmployeeRepository employeeRepository)
        {
        ...
        public void OnGet(string? id)
        {
            ...
            Tickets = Tickets.Where(x => x.Statu == "Review").ToList();
            var employees = Tickets.Where(x => x.Statu == "Review")
